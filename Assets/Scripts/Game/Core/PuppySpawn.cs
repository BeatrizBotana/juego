...
namespace Gamekit3D
{
    public class PuppySpawn : MonoBehaviour
    {
        ...
        public Material[] PuppyRespawnMaterials;
        public GameObject respawnParticles;
        Material[] PuppyMaterials;
        ...
        void Awake()
        {
            ...
            PuppyMaterials = m_Renderer.materials;
        ...
        {
            m_Started = false;
            m_Renderer.materials = PuppyRespawnMaterials;
            Set(0.001f);
        ...
        void Update()
        {
            ...
            if (cutoff >= 1.0f)
            {
                m_Renderer.materials = PuppyMaterials;
                this.enabled = false;
            }
        }
