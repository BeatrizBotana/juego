...
namespace Gamekit3D
{
    ...
    public class CameraSettingsEditor : Editor
    {
        ...
        GUIContent m_FollowContent = new GUIContent("Follow", "Used to determine how the cameras move.  It should be set to Puppy.");
        GUIContent m_LookAtContent = new GUIContent("Look At", "Used to determine how the cameras aim.  It should be set to HeadTarget (this is a child within Puppy's hierarchy).");
